...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    public  Collection<?> checkAgendamento(Long client_id);
    ...
    public  Collection<?> checkDesconto(Long client_id, java.sql.Date data_inicio, java.sql.Date data_fim);
    ...
    public  Collection<?> checkCancelamento(Long client_id, java.sql.Date data_inicio, java.sql.Date data_fim);
}
